		...
		<div class="header-w3l">
			<div class="container">
				...
				<div class="" style="float:right; margin:20px;">
					...
					<a href="admin/login.php" ><span><?php if(isset($_COOKIE["username"])) echo $_COOKIE['username'];else echo "Giriş";?> </span><img src="images/login.png" width="50px" height="50px"></a>
	...
	<div class="container">
		...
		<div class="mail-w3l-agile">
			...
			<div class="col-md-6 col-sm-6 agileinfo_mail_grid_right">
				<h3>Get In Touch</h3>
				<form id="cont"   method="post" action="contact.php" enctype="multipart/form-data">
